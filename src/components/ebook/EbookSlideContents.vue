      ...
      return Promise.all(
        this.currentBook.spine.spineItems.map(
          item => item.load(this.currentBook.load.bind(this.currentBook))
            ...
            .finally(item.unload.bind(item))) // 完成后释放内存
      ).then(results =>
        Promise.resolve([].concat.apply([], results))) // 多维数组转换为一维数组
    }
  }
}
</script>
      ...
      .slide-contents-book-info-wrapper {
        ...
        .slide-contents-book-title {
          ...
          .slide-contents-book-title-text {
            // 357*0.8-30-20-45-70=153.75
            @include ellipsis2(2); // 显示两行进行隐藏
          }
        }
    ...
    .slide-contents-list {
      ...
      .slide-contents-item {
        ...
        .slide-contents-item-label {
          flex: 1;
          font-size: px2rem(14);
          line-height: px2rem(16); // 防止英文字母显示不完全
          @include ellipsis;
        }
